...
<body>
    ...
    <section>
        <div id="Financial_literacy" class="section">
            ...
            <a class="links" href="Financial _litrecy.html">Financial
                literacy</a>
        </div>
        <div id="Investing" class="section">
            ...
            <a class="links" href="Investing.html">Investing</a>
        </div>
        <div id="Nifty" class="section">
            ...
            <p><span>Nifty stands for National Stock Exchange Fifty and is the equity benchmark index of the National
                    ...
                    Nifty.</span></p>
            <a class="links" href="Nifty.html">Nifty</a><br>
        ...
        <div>
            ...
            <a href="/index.html"></a><input type="button" value="GET STARTED">
            </form>
        </div>
    </section>
